...
public class MancalaModel {
    ...
    private int[] undoCount;        // index 0 = Player A current turn undo's, index 1 = Player B current turn undo's
    ...
    public void makeMove(int pitIndex) {
        if ((currentPlayer == 0 && pitIndex >= 0 && pitIndex < 6) || (currentPlayer == 1 && pitIndex >= 7 && pitIndex < 13)) {
            saveState();
    ...
    private void switchPlayer() {
        ...
        this.undoCount[this.currentPlayer] = 0;
    }
    ...
    public int getUndoCount() { return undoCount[this.currentPlayer]; }
